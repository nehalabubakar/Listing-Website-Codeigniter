                ...
                <table class="table table-bordered datatable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center"><img class = "rounded-circle img-thumbnail" src="<?php echo base_url('mobile/uploads/listing_cover_photo/'.$listing['listing_cover']); ?>" alt="" style="height: 50px; width: 50px;"></td>
