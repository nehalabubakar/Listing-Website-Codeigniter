  ...
  <div class="col-sm-offset-3 col-sm-3">
    <div class="col-lg-12">
      <div class="custom-control custom-radio">
        ...
        <label class="custom-control-label" for="general"><i class="fas fa-store-alt" style="color: #636363;"></i> <?php echo get_phrase('general'); ?></label>
      </div>
    </div>
    ...
    <div class="col-lg-12">
      <div class="custom-control custom-radio">
        ...
        <label class="custom-control-label" for="restaurant"><i class="fa fa-utensils" style="color: #636363;"></i> <?php echo get_phrase('restaurant'); ?></label>
      </div>
    </div>
    ...
    <div class="col-lg-12">
      <div class="custom-control custom-radio">
        ...
        <label class="custom-control-label" for="shop"><i class="fa fa-store" style="color: #636363;"></i> <?php echo get_phrase('shop'); ?></label>
      </div>
    </div>
    ...
    <div class="col-lg-12">
      <div class="custom-control custom-radio">
        ...
        <label class="custom-control-label" for="beauty"><i class="fas fa-spa" style="color: #636363;"></i> <?php echo get_phrase('beauty'); ?></label>
      </div>
    </div>
  </div>
