                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                          ...
                          <div class="fileinput fileinput-new" data-provides="fileinput">
                            <div class="fileinput-new thumbnail" style="width: 200px; height: 200px;" data-trigger="fileinput">
                                <?php
                                    if(file_exists('mobile/uploads/user_background/'.$this->session->userdata('user_id').'.jpg')):
                                        $bg_img = base_url('mobile/uploads/user_background/'.$this->session->userdata('user_id').'.jpg');
                                    else:
