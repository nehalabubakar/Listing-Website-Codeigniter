...
<body>
    ...
    <img src="<?php echo base_url() . 'assets/global/logo-sm.png'; ?>" width="15%;" style="opacity: 0.05;">
    <form method="post" action="<?php echo site_url('user/payment_success/stripe/' . $user_details['id'] . '/' . $package_details['id'] . '/' . $package_details['price']); ?>">
        <label>
