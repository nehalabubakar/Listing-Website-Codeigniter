						...
						<div class="col-sm-7">
							...
							<div class="fileinput fileinput-new" data-provides="fileinput">
								<div class="fileinput-new thumbnail" style="width: 200px; height: 200px;" data-trigger="fileinput">
									<?php if (file_exists('mobile/uploads/category_thumbnails/'.$category_details['thumbnail'])): ?>
										<img src="<?php echo base_url('mobile/uploads/category_thumbnails/'.$category_details['thumbnail']); ?>">
									<?php else: ?>
										<img src="<?php echo base_url('mobile/uploads/category_thumbnails/thumbnail.png'); ?>">
									<?php endif; ?>
								</div>
