  ...
  <div class="col-lg-7">
    <div class="panel panel-primary" data-collapsed="0">
      ...
      <div class="panel-body">
        ...
        <div class="form-group">
          <label for="purchase_code" class="col-sm-3 control-label">Unique Code</label>
          <div class="col-sm-7">
            <input type="text" class="form-control" name="purchase_code" id="purchase_code" placeholder="code" value="<?php echo get_settings('purchase_code');  ?>">
          </div>
        </div>
