        ...
        <div class="col-xl-6">
            <div class="card">
                ...
                <div class="col-xl-12">
                    ...
                    <div class="d-flex">
                        <div class="">
                            <img class = "rounded-circle img-thumbnail" src="<?php echo base_url('mobile/uploads/thumbnails/listing_thumbnails/'.$listing_details['thumbnail']); ?>" alt="" style="height: 50px; width: 50px;">
                        </div>
                ...
                <div class="col-xl-12">
                        ...
                        <?php foreach (json_decode($listing_details['photos']) as $key => $photo): ?>
                            ...
                            <?php if ($key == 0): ?>
                                <div class="d-flex mb-1">
                                    <div class="">
                                        <img class = "rounded-circle img-thumbnail" src="<?php echo base_url('mobile/uploads/listing_images/'.$photo); ?>" alt="" style="height: 50px; width: 50px;">
                                    </div>
                    ...
                    <div id="blank_photo_uploader">
                        <div class="d-flex mt-2 appendedPhotoUploader">
                            <div class="">
                                <img class = "rounded-circle img-thumbnail" src="<?php echo base_url('mobile/uploads/placeholder.png'); ?>" alt="" style="height: 50px; width: 50px;">
                            </div>
                            <div class="flex-grow-1 px-3">
                                <div class="input-group">
                                    <div class="custom-file">
