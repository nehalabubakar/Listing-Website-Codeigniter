						...
						<div class="col-md-4">
							<div class="form-group" id = "thumbnail-picker-area">
								...
								<div class="col-sm-10">
									<div class="fileinput fileinput-new" data-provides="fileinput">
										<div class="fileinput-new thumbnail" style="width: 200px; height: 200px;" data-trigger="fileinput">
											<?php if(file_exists('mobile/uploads/blog_thumbnails/'.$blog['blog_thumbnail'])): ?>
												<img src="<?php echo base_url('mobile/uploads/blog_thumbnails/'.$blog['blog_thumbnail']); ?>" alt="...">
											<?php else: ?>
												<img src="<?php echo base_url('mobile/uploads/blog_thumbnails/thumbnail.png'); ?>" alt="...">
											<?php endif; ?>
										</div>
								...
								<div class="col-sm-10">
									...
									<div class="fileinput fileinput-new" data-provides="fileinput">
										<div class="fileinput-new thumbnail" style="width: 200px; height: 200px;" data-trigger="fileinput">
											<?php if(file_exists('mobile/uploads/blog_cover_images/'.$blog['blog_cover'])): ?>
												<img src="<?php echo base_url('mobile/uploads/blog_cover_images/'.$blog['blog_cover']); ?>" alt="...">
											<?php else: ?>
												<img src="<?php echo base_url('mobile/uploads/blog_cover_images/thumbnail.png'); ?>" alt="...">
											<?php endif; ?>
										</div>
										<div class="fileinput-preview fileinput-exists thumbnail" style="max-width: 200px; max-height: 150px"></div>
										<div>
