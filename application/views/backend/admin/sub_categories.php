                     ...
                     foreach ($sub_categories as $sub_category):
                      ...
                      ?>
                        <tr>
                            ...
                            <td class="text-center"><img class="rounded-circle img-thumbnail" src="<?php echo base_url('mobile/uploads/category_thumbnails/'.$sub_category['thumbnail']); ?>" alt="" height="auto" width="50px;"></td>
