				...
				<form class="" action="<?php echo site_url('login/register_user') ?>" method="post">
					<div class="form_container">
						...
						<div class="row mt-1">
							...
							<div class="col-md-12">
								<a id="sign_up_using_phone" class="btn_1 full-width outline wishlist icon-login" href="<?php echo site_url('home/sign_up_using_phone'); ?>">Sign Up Using Phone Number</a>
							</div>
							<div class="col-md-12">
