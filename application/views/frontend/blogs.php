						...
						<li>
							<div class="alignleft">
								<a href="<?php echo site_url('home/post/'.$latest_post['id'].'/'.slugify($latest_post['title'])); ?>">
									<?php if(file_exists('mobile/uploads/blog_thumbnails/'.$latest_post['blog_thumbnail'])): ?>
										<img src="<?php echo base_url('mobile/uploads/blog_thumbnails/'.$latest_post['blog_thumbnail']); ?>" alt="...">
									<?php else: ?>
