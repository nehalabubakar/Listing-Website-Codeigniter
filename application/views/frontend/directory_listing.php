<div class="hero_in shop_detail" style="background: url(<?php echo base_url('mobile/uploads/listing_cover_photo/' . $listing_details['listing_cover']); ?>) center center no-repeat; background-size: cover;">
</div>
<!--/hero_in-->
				...
				<div class="add_bottom_15">
					...
					?>
						<span class="loc_open mr-2">
							<a href="<?php echo site_url('home/filter_listings?category=' . slugify($category_name) . '&&status=all'); ?>" style="color: #32a067;">
					...
					<div class="grid-gallery">
						<ul class="magnific-gallery">
							<?php foreach (json_decode($listing_details['photos']) as $key => $photo) : ?>
								<?php if (file_exists('mobile/uploads/listing_images/' . $photo)) : ?>
									<li>
										<figure>
											<img src="<?php echo base_url('mobile/uploads/listing_images/' . $photo); ?>" alt="">
											<figcaption>
												<div class="caption-content">
													<a href="<?php echo base_url('mobile/uploads/listing_images/' . $photo); ?>" title="" data-effect="mfp-zoom-in">
