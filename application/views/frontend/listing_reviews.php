						...
						<div class="col-6">
							<div class="row">
								...
								<div class="col-12 mt-3">
									<?php $badge = '<div id=\'badge\'> </div><script src=\'' . base_url() . 'home/listing_data/' . $this->uri->segment(3) . '\' type=\'text/javascript\'></script>'; ?>
									<a href='javascript::' class="btn btn-success float-right btn-sm" id="get_badge_button" onclick="CopyToClipboard()"> Get Badge </a>
								</div>
								<div class=" col-12">
...
<script>
	...
	function CopyToClipboard() {
		...
		var aux = '<div id="badge"></div>' + '<scr' + 'ipt ' + 'type="text/javascript" src="' + base_url + 'home/listing_data/' + id + '">' + '</scr' + 'ipt>';

		// create a hidden textarea
		var dummy_textarea = document.createElement("textarea");

		// Append it to the body
		document.body.appendChild(dummy_textarea);

		dummy_textarea.value = aux;
