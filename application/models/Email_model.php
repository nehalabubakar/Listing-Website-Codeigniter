...
class Email_model extends CI_Model
{
	...
	public function request_approved_mail($booking_id = "")
	{
		...
		$message = 'Congratulations! ' . $this->db->get_where('listing', array('id' => $booking['listing_id']))->row('name') . 'Your request has been accepted At the right time ' . $this->db->get_where('listing', array('id' => $booking['listing_id']))->row('name');
